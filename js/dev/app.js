...
var _config$1 = {
  ...
  overwrite: false,
  delay: 0
}, _suppressOverwrites$1, _reverting$1, _context$4, _bigNum$2 = 1e8, _tinyNum = 1 / _bigNum$2, _2PI = Math.PI * 2, _HALF_PI = _2PI / 4, _gsID = 0, _sqrt = Math.sqrt, _cos = Math.cos, _sin = Math.sin, _isString$2 = function _isString2(value) {
...
}, _isArray$1 = Array.isArray, _strictNumExp = /(?:-?\.?\d|\.)+/gi, _numExp = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, _numWithUnitExp = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, _complexStringNumExp = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, _relExp = /[+-]=-?[.\d]+/, _delimitedValueExp = /[^,'"\[\]\s]+/gi, _unitExp = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, _globalTimeline, _win$5, _coreInitted$5, _doc$5, _globals = {}, _installScope = {}, _coreReady, _install = function _install2(scope) {
  return (_installScope = _merge(scope, _globals)) && gsap$8;
  ...
  return p;
}, _setDefaults$2 = function _setDefaults2(obj, defaults2) {
  ...
  for (var p in toMerge) {
    p !== "__proto__" && p !== "constructor" && p !== "prototype" && (base[p] = _isObject$2(toMerge[p]) ? _mergeDeep2(base[p] || (base[p] = {}), toMerge[p]) : toMerge[p]);
  }
  return base;
  ...
  return _context$4 && !scope && _context$4.selector ? _context$4.selector(value) : _isString$2(value) && !leaveStrings && (_coreInitted$5 || !_wake()) ? _slice.call((scope || _doc$5).querySelectorAll(value), 0) : _isArray$1(value) ? _flatten(value, leaveStrings) : _isArrayLike(value) ? _slice.call(value, 0) : value ? [value] : [];
  ...
  return result;
}, _interrupt$1 = function _interrupt2(animation) {
  ...
  if (_windowExists$4() || config3.headless) {
    ...
    config3.register && config3.register(gsap$8, Plugin, PropTween);
  } else {
  ...
  _self = {
    ...
    wake: function wake() {
      if (_coreReady) {
        if (!_coreInitted$5 && _windowExists$4()) {
          _win$5 = _coreInitted$5 = window;
          _doc$5 = _win$5.document || {};
          _globals.gsap = gsap$8;
          (_win$5.gsapVersions || (_win$5.gsapVersions = [])).push(gsap$8.version);
...
var Context = /* @__PURE__ */ (function() {
  ...
  _proto5.add = function add(name, func, scope) {
    ...
    self.last = f;
    return name === _isFunction$3 ? f(self, function(func2) {
...
var _gsap = {
  ...
  quickSetter: function quickSetter(target, property, unit) {
    ...
    if (target.length > 1) {
      var setters = target.map(function(t) {
        return gsap$8.quickSetter(t, property, unit);
      }), l = setters.length;
      return function(value) {
        var i = l;
        while (i--) {
  ...
  quickTo: function quickTo(target, property, vars) {
    var _setDefaults22;
    var tween = gsap$8.to(target, _setDefaults$2((_setDefaults22 = {}, _setDefaults22[property] = "+=0.1", _setDefaults22.paused = true, _setDefaults22.stagger = 0, _setDefaults22), vars || {})), func = function func2(value, start, startIsRelative) {
  ...
  registerEffect: function registerEffect(_ref3) {
    ...
    _effects[name] = function(targets, vars, tl) {
      return effect(toArray(targets), _setDefaults$2(vars || {}, defaults2), tl);
    };
    if (extendTimeline) {
...
var gsap$8 = _gsap.registerPlugin({
  name: "attr",
...
Tween.version = Timeline.version = gsap$8.version = "3.13.0";
_coreReady = 1;
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var _win$4, _doc$4, _docElement$2, _pluginInitted, _tempDiv$2, _recentSetterPlugin, _reverting, _windowExists$3 = function _windowExists22() {
  return typeof window !== "undefined";
}, _transformProps = {}, _RAD2DEG$2 = 180 / Math.PI, _DEG2RAD$1 = Math.PI / 180, _atan2 = Math.atan2, _bigNum$1 = 1e8, _capsExp$1 = /([A-Z])/g, _horizontalExp = /(left|right|width|margin|padding|x)/i, _complexExp = /[\s,\(]\S/, _propertyAliases = {
...
}, _getStyleSaver$2 = function _getStyleSaver2(target, properties) {
  var saver = {
    target,
    props: [],
    revert: _revertStyle,
  ...
  target._gsap || gsap$8.core.getCache(target);
  ...
  return e && e.style ? e : _doc$4.createElement(type);
...
}, _initCore$4 = function _initCore2() {
  if (_windowExists$3() && window.document) {
    ...
    _reverting = gsap$8.core.reverting;
    _pluginInitted = 1;
  }
  ...
  */
  ...
  return _isNullTransform(matrixString) ? _identity2DMatrix : matrixString.substr(7).match(_numExp).map(_round$3);
  ...
  if (matrix !== _identity2DMatrix) {
    ...
    if (matrix.length === 6) {
      ...
      rotation = a || b ? _atan2(b, a) * _RAD2DEG$2 : 0;
      skewX = c || d ? _atan2(c, d) * _RAD2DEG$2 + rotation : 0;
  ...
  var cap = 360, isString = _isString$2(endValue), endNum = parseFloat(endValue) * (isString && ~endValue.indexOf("rad") ? _RAD2DEG$2 : 1), change = endNum - startNum, finalValue = startNum + change + "deg", direction, pt;
  if (isString) {
      ...
      if (specialProp) {
        ...
        if (isTransformRelated) {
          ...
          if (!transformPropTween) {
            ...
            transformPropTween = this._pt = new PropTween(this._pt, style, _transformProp$3, 0, 1, cache.renderTransform, cache, 0, -1);
...
gsap$8.utils.checkPrefix = _checkPropPrefix;
gsap$8.core.getStyleSaver = _getStyleSaver$2;
...
gsap$8.registerPlugin(CSSPlugin);
var gsapWithCSS = gsap$8.registerPlugin(CSSPlugin) || gsap$8;
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var gsap$7, _coreInitted$4, _win$3, _doc$3, _docEl$2, _body$5, _isTouch, _pointerType, ScrollTrigger$2, _root$1, _normalizer$1, _eventTypes, _context$3, _getGSAP$5 = function _getGSAP() {
  ...
  sc: _scrollCacheFunc(function(value) {
    return arguments.length ? _win$3.scrollTo(value, _vertical.sc()) : _win$3.pageXOffset || _doc$3[_scrollLeft] || _docEl$2[_scrollLeft] || _body$5[_scrollLeft] || 0;
  })
}, _vertical = {
  s: _scrollTop,
  p: "top",
  ...
  op: _horizontal,
  sc: _scrollCacheFunc(function(value) {
    return arguments.length ? _win$3.scrollTo(_horizontal.sc(), value) : _win$3.pageYOffset || _doc$3[_scrollTop] || _docEl$2[_scrollTop] || _body$5[_scrollTop] || 0;
  })
}, _getTarget = function _getTarget2(t, self) {
  return (self && self._ctx && self._ctx.selector || gsap$7.utils.toArray)(t)[0] || (typeof t === "string" && gsap$7.config().nullTargetWarn !== false ? console.warn("Element not found:", t) : null);
  ...
  func.target = element;
  prev || (func.smooth = gsap$7.getProperty(element, "scrollBehavior") === "smooth");
  return func;
  ...
  ScrollTrigger$2 = gsap$7.core.globals().ScrollTrigger;
  ScrollTrigger$2 && ScrollTrigger$2.core && _integrate();
}, _initCore$3 = function _initCore(core) {
  gsap$7 = core || _getGSAP$5();
  if (!_coreInitted$4 && gsap$7 && typeof document !== "undefined" && document.body) {
    _win$3 = window;
    _doc$3 = document;
    _docEl$2 = _doc$3.documentElement;
    _body$5 = _doc$3.body;
    _root$1 = [_win$3, _doc$3, _docEl$2, _body$5];
    gsap$7.utils.clamp;
    _context$3 = gsap$7.core.context || function() {
    };
...
var Observer = /* @__PURE__ */ (function() {
  ...
  _proto.init = function init6(vars) {
    _coreInitted$4 || _initCore$3(gsap$7) || console.warn("Please gsap.registerPlugin(Observer)");
    ...
    this.vars = vars;
    ignore && (ignore = gsap$7.utils.toArray(ignore));
    ...
    lineHeight || (lineHeight = parseFloat(_win$3.getComputedStyle(_body$5).lineHeight) || 22);
    var id, onStopDelayedCall, dragged, moved, wheeled, locked, axis, self = this, prevDeltaX = 0, prevDeltaY = 0, passive = vars.passive || !preventDefault && vars.passive !== false, scrollFuncX = _getScrollFunc(target, _horizontal), scrollFuncY = _getScrollFunc(target, _vertical), scrollX = scrollFuncX(), scrollY = scrollFuncY(), limitToTouch = ~type.indexOf("touch") && !~type.indexOf("pointer") && _eventTypes[0] === "pointerdown", isViewport = _isViewport$1(target), ownerDoc = target.ownerDocument || _doc$3, deltaX = [0, 0, 0], deltaY = [0, 0, 0], onClickTime = 0, clickCapture = function clickCapture2() {
      ...
      if (!isDragNotClick && isTrackingDrag) {
        ...
        if (preventDefault && allowClicks) {
          gsap$7.delayedCall(0.08, function() {
    ...
    onStopDelayedCall = self._dc = gsap$7.delayedCall(onStopDelay || 0.25, onStopFunc).pause();
    self.deltaX = self.deltaY = 0;
...
_getGSAP$5() && gsap$7.registerPlugin(Observer);
/*!
...
var gsap$6, _coreInitted$3, _win$2, _doc$2, _docEl$1, _body$4, _root, _resizeDelay, _toArray$4, _clamp, _time2, _syncInterval, _refreshing, _pointerIsDown, _transformProp$2, _i, _prevWidth, _prevHeight, _autoRefresh, _sort, _suppressOverwrites, _ignoreResize, _normalizer, _ignoreMobileResize, _baseScreenHeight, _baseScreenWidth, _fixIOSBug, _context$2, _scrollRestoration, _div100vh, _100vh, _isReverted, _clampingMax, _limitCallbacks, _startup = 1, _getTime$1 = Date.now, _time1 = _getTime$1(), _lastScrollTime = 0, _enabled = 0, _parseClamp = function _parseClamp2(value, type, self) {
  ...
  return gsap$6 || _windowExists$2() && (gsap$6 = window.gsap) && gsap$6.registerPlugin && gsap$6;
}, _isViewport2 = function _isViewport3(e) {
  return !!~_root.indexOf(e);
}, _getViewportDimension = function _getViewportDimension2(dimensionProperty) {
  return (dimensionProperty === "Height" ? _100vh : _win$2["inner" + dimensionProperty]) || _docEl$1["client" + dimensionProperty] || _body$4["client" + dimensionProperty];
  ...
  return Math.max(0, (s = "scroll" + d2) && (a = _getProxyProp(element, s)) ? a() - _getBoundsFunc(element)()[d] : _isViewport2(element) ? (_docEl$1[s] || _body$4[s]) - _getViewportDimension(d2) : element[s] - element["offset" + d2]);
  ...
  var tween = withoutTransforms && _getComputedStyle$1(element)[_transformProp$2] !== "matrix(1, 0, 0, 1, 0, 0)" && gsap$6.to(element, {
    x: 0,
    y: 0,
    xPercent: 0,
    yPercent: 0,
  ...
  return function(value) {
    return gsap$6.utils.snap(_getLabelRatioArray(animation), value);
  };
}, _snapDirectional = function _snapDirectional2(snapIncrementOrArray) {
  var snap3 = gsap$6.utils.snap(snapIncrementOrArray), a = Array.isArray(snapIncrementOrArray) && snapIncrementOrArray.slice(0).sort(function(a2, b) {
    return a2 - b;
  });
  ...
  _body$4 = _doc$2.body;
  _root = [_win$2, _doc$2, _docEl$1, _body$4];
  ...
  if (state) {
    ...
    (state.t._gsap || gsap$6.core.getCache(state.t)).uncache = 1;
    for (; i < l; i += 2) {
      value = state[i + 1];
      p = state[i];
      if (value) {
  ...
  if (!_isNumber(value)) {
    ...
    element = _getTarget(trigger, self) || _body$4;
    ...
    containerAnimation && (value = gsap$6.utils.mapRange(containerAnimation.scrollTrigger.start, containerAnimation.scrollTrigger.end, 0, scrollerMax, value));
  ...
  if (marker) {
    ...
    _positionMarker(marker, position, direction, isStart && position > 20 || !isStart && (useFixedPosition ? Math.max(_body$4[p1], _docEl$1[p1]) : marker.parentNode[p1]) <= position + 1);
    if (useFixedPosition) {
  ...
  if (element.parentNode !== parent) {
    ...
    gsap$6.core.getCache(element).uncache = 1;
  ...
  var getScroll = _getScrollFunc(scroller, direction), prop = "_scroll" + direction.p2, getTween = function getTween2(scrollTo, vars, initialValue, change1, change2) {
    ...
    tween = getTween2.tween = gsap$6.to(scroller, vars);
    return tween;
  };
...
var ScrollTrigger$1 = /* @__PURE__ */ (function() {
  function ScrollTrigger2(vars, animation) {
    _coreInitted$3 || ScrollTrigger2.register(gsap$6) || console.warn("Please gsap.registerPlugin(ScrollTrigger)");
    _context$2(this);
  ...
  _proto.init = function init6(vars, animation) {
    ...
    self.scrubDuration = function(value) {
      ...
      if (!scrubSmooth) {
        ...
        scrubTween ? scrubTween.duration(value) : scrubTween = gsap$6.to(animation, {
          ease: "expo",
          totalProgress: "+=0",
          inherit: false,
    ...
    if (snap3) {
      ...
      "scrollBehavior" in _body$4.style && gsap$6.set(isViewport ? [_body$4, _docEl$1] : scroller, {
        scrollBehavior: "auto"
      });
      _scrollers.forEach(function(o) {
        return _isFunction$2(o) && o.target === (isViewport ? _doc$2.scrollingElement || _docEl$1 : scroller) && (o.smooth = false);
      });
      snapFunc = _isFunction$2(snap3.snapTo) ? snap3.snapTo : snap3.snapTo === "labels" ? _getClosestLabel(animation) : snap3.snapTo === "labelsDirectional" ? _getLabelAtDirection(animation) : snap3.directional !== false ? function(value, st) {
        return _snapDirectional(snap3.snapTo)(value, _getTime$1() - lastRefresh < 500 ? 0 : st.direction);
      } : gsap$6.utils.snap(snap3.snapTo);
      snapDurClamp = snap3.duration || {
        min: 0.1,
        max: 2
      };
      snapDurClamp = _isObject$1(snapDurClamp) ? _clamp(snapDurClamp.min, snapDurClamp.max) : _clamp(snapDurClamp, snapDurClamp);
      snapDelayedCall = gsap$6.delayedCall(snap3.delay || scrubSmooth / 2 || 0.1, function() {
        var scroll = scrollFunc(), refreshedRecently = _getTime$1() - lastRefresh < 500, tween = tweenTo.tween;
        if ((refreshedRecently || Math.abs(self.getVelocity()) < 10) && !tween && !_pointerIsDown && lastSnap !== scroll) {
          var progress = (scroll - start) / change, totalProgress = animation && !isToggle ? animation.totalProgress() : progress, velocity = refreshedRecently ? 0 : (totalProgress - snap22) / (_getTime$1() - _time2) * 1e3 || 0, change1 = gsap$6.utils.clamp(-progress, 1 - progress, _abs(velocity / 2) * velocity / 0.185), naturalEnd = progress + (snap3.inertia === false ? 0 : change1), endValue, endScroll, _snap = snap3, onStart = _snap.onStart, _onInterrupt = _snap.onInterrupt, _onComplete = _snap.onComplete;
    ...
    if (pin) {
      ...
      vars.force3D !== false && gsap$6.set(pin, {
        force3D: true
      });
    ...
    if (markers) {
      ...
      containerAnimation && (caMarkerSetter = gsap$6.quickSetter([markerStart, markerEnd], direction.a, _px));
      if (!useFixedPosition && !(_proxies.length && _getProxyProp(scroller, "fixedMarkers") === true)) {
        _makePositionable(isViewport ? _body$4 : scroller);
        gsap$6.set([markerStartTrigger, markerEndTrigger], {
          force3D: true
        });
    ...
    self.refresh = function(soft, force, position, pinOffset) {
      ...
      if (markers && _isObject$1(position)) {
        markerStartOffset = gsap$6.getProperty(markerStartTrigger, direction.p);
        markerEndOffset = gsap$6.getProperty(markerEndTrigger, direction.p);
      }
      while (i-- > 0) {
      ...
      if (_isString$1(parsedEnd) && !parsedEnd.indexOf("+=")) {
        if (~parsedEnd.indexOf(" ")) {
          ...
          parsedEnd = _isString$1(parsedStart) ? parsedStart : (containerAnimation ? gsap$6.utils.mapRange(0, containerAnimation.duration(), containerAnimation.scrollTrigger.start, containerAnimation.scrollTrigger.end, start) : start) + offset2;
      ...
      if (isFirstRefresh) {
        prevProgress = gsap$6.utils.clamp(0, 1, gsap$6.utils.normalize(start, end, prevScroll));
      }
      ...
      if (markerStart && offset2) {
        ...
        gsap$6.set([markerStart, markerEnd], cs2);
      }
      if (pin && !(_clampingMax && self.end >= _maxScroll(scroller, direction))) {
        ...
        if (!max && end > 1) {
          ...
          if (isViewport && _getComputedStyle$1(_body$4)["overflow" + direction.a.toUpperCase()] !== "scroll") {
      ...
      if (isFirstRefresh || prevProgress !== self.progress || containerAnimation || invalidateOnRefresh || animation && !animation._initted) {
        animation && !isToggle && (animation._initted || prevProgress || animation.vars.immediateRender !== false) && animation.totalProgress(containerAnimation && start < -1e-3 && !prevProgress ? gsap$6.utils.normalize(start, end, 0) : prevProgress, true);
    ...
    if (animation && animation.add && !change) {
      ...
      gsap$6.delayedCall(0.01, self.update);
      change = 0.01;
      start = end = 0;
    } else {
      self.refresh();
  ...
  ScrollTrigger2.disable = function disable(reset, kill2) {
    ...
    _removeListener$1(_win$2, "wheel", _onScroll2);
    _removeListener$1(_doc$2, "scroll", _onScroll2);
    clearInterval(_syncInterval);
    _removeListener$1(_doc$2, "touchcancel", _passThrough);
    _removeListener$1(_body$4, "touchstart", _passThrough);
  ...
  ScrollTrigger2.enable = function enable() {
    ...
    if (gsap$6) {
      ...
      _clamp = gsap$6.utils.clamp;
      _context$2 = gsap$6.core.context || _passThrough;
      _suppressOverwrites = gsap$6.core.suppressOverwrites || _passThrough;
      _scrollRestoration = _win$2.history.scrollRestoration || "auto";
      _lastScroll = _win$2.pageYOffset || 0;
      gsap$6.core.globals("ScrollTrigger", ScrollTrigger2);
      if (_body$4) {
        _enabled = 1;
        ...
        _refresh100vh();
        _rafBugFix();
        Observer.register(gsap$6);
        ScrollTrigger2.isTouch = Observer.isTouch;
        _fixIOSBug = Observer.isTouch && /(iPad|iPhone|iPod|Mac)/g.test(navigator.userAgent);
        _ignoreMobileResize = Observer.isTouch === 1;
        _addListener$1(_win$2, "wheel", _onScroll2);
        _root = [_win$2, _doc$2, _docEl$1, _body$4];
        if (gsap$6.matchMedia) {
          ScrollTrigger2.matchMedia = function(vars) {
            var mm = gsap$6.matchMedia(), p;
            for (p in vars) {
              mm.add(p, vars[p]);
            }
            return mm;
          };
          gsap$6.addEventListener("matchMediaInit", function() {
            return _revertAll();
          });
          gsap$6.addEventListener("matchMediaRevert", function() {
            return _revertRecorded();
          });
          gsap$6.addEventListener("matchMedia", function() {
            _refreshAll(0, 1);
            _dispatch("matchMedia");
          });
          gsap$6.matchMedia().add("(orientation: portrait)", function() {
            _setBaseDimensions();
        ...
        _setBaseDimensions();
        _addListener$1(_doc$2, "scroll", _onScroll2);
        var bodyHasStyle = _body$4.hasAttribute("style"), bodyStyle = _body$4.style, border = bodyStyle.borderTopStyle, AnimationProto = gsap$6.core.Animation.prototype, bounds, i;
        ...
        if (!bodyHasStyle) {
          _body$4.setAttribute("style", "");
          _body$4.removeAttribute("style");
        }
        _syncInterval = setInterval(_sync, 250);
        gsap$6.delayedCall(0.5, function() {
          return _startup = 0;
        });
        _addListener$1(_doc$2, "touchcancel", _passThrough);
        _addListener$1(_body$4, "touchstart", _passThrough);
        ...
        _transformProp$2 = gsap$6.utils.checkPrefix("transform");
        _stateProps.push(_transformProp$2);
        _coreInitted$3 = _getTime$1();
  ...
  ScrollTrigger2.scrollerProxy = function scrollerProxy(target, vars) {
    ...
    if (vars) {
      isViewport ? _proxies.unshift(_win$2, vars, _body$4, vars, _docEl$1, vars) : _proxies.unshift(t, vars);
    }
  };
...
ScrollTrigger$1.saveStyles = function(targets) {
  return targets ? _toArray$4(targets).forEach(function(target) {
    if (target && target.style) {
      ...
      _savedStyles.push(target, target.style.cssText, target.getBBox && target.getAttribute("transform"), gsap$6.core.getCache(target), _context$2());
    }
  }) : _savedStyles;
};
...
ScrollTrigger$1.batch = function(targets, vars) {
  var result = [], varsCopy = {}, interval = vars.interval || 0.016, batchMax = vars.batchMax || 1e9, proxyCallback = function proxyCallback2(type, callback) {
    var elements = [], triggers = [], delay = gsap$6.delayedCall(interval, function() {
...
var _clampScrollAndGetDurationMultiplier = function _clampScrollAndGetDurationMultiplier2(scrollFunc, current, end, max) {
  ...
  target === _docEl$1 && _allowNativePanning2(_body$4, direction);
}, _overflow = {
  auto: 1,
  scroll: 1
}, _nestedScroll = function _nestedScroll2(_ref5) {
  var event = _ref5.event, target = _ref5.target, axis = _ref5.axis;
  var node = (event.changedTouches ? event.changedTouches[0] : event).target, cache = node._gsap || gsap$6.core.getCache(node), time = _getTime$1(), cs;
  if (!cache._isScrollT || time - cache._isScrollT > 2e3) {
    while (node && node !== _body$4 && (node.scrollHeight <= node.clientHeight && node.scrollWidth <= node.clientWidth || !(_overflow[(cs = _getComputedStyle$1(node)).overflowY] || _overflow[cs.overflowX]))) {
  ...
  var _vars2 = vars, normalizeScrollX = _vars2.normalizeScrollX, momentum = _vars2.momentum, allowNestedScroll = _vars2.allowNestedScroll, onRelease = _vars2.onRelease, self, maxY, target = _getTarget(vars.target) || _docEl$1, smoother = gsap$6.core.globals().ScrollSmoother, smootherInstance = smoother && smoother.get(), content = _fixIOSBug && (vars.content && _getTarget(vars.content) || smootherInstance && vars.content !== false && !smootherInstance.smooth() && smootherInstance.content()), scrollFuncY = _getScrollFunc(target, _vertical), scrollFuncX = _getScrollFunc(target, _horizontal), scale = 1, initialScale = (Observer.isTouch && _win$2.visualViewport ? _win$2.visualViewport.scale * _win$2.visualViewport.width : _win$2.outerWidth) / _win$2.innerWidth, wheelRefresh = 0, resolveMomentumDuration = _isFunction$2(momentum) ? function() {
  ...
  vars.onPress = function() {
    skipTouchMove = false;
    var prevScale = scale;
    scale = _round$2((_win$2.visualViewport && _win$2.visualViewport.scale || 1) / initialScale);
    tween.pause();
  ...
  _fixIOSBug && gsap$6.ticker.add(_passThrough);
  onStopDelayedCall = self._dc;
  tween = gsap$6.to(self, {
    ease: "power4",
    paused: true,
    inherit: false,
...
_getGSAP$4() && gsap$6.registerPlugin(ScrollTrigger$1);
/*!
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var gsap$5, _coreInitted$2, _window, _docEl, _body$3, _toArray$3, _config, ScrollTrigger, _windowExists$1 = function _windowExists3() {
  return typeof window !== "undefined";
}, _getGSAP$3 = function _getGSAP3() {
  return gsap$5 || _windowExists$1() && (gsap$5 = window.gsap) && gsap$5.registerPlugin && gsap$5;
}, _isString3 = function _isString4(value) {
  return typeof value === "string";
}, _isFunction$1 = function _isFunction3(value) {
  return typeof value === "function";
}, _max = function _max2(element, axis) {
  var dim = axis === "x" ? "Width" : "Height", scroll = "scroll" + dim, client = "client" + dim;
  return element === _window || element === _docEl || element === _body$3 ? Math.max(_docEl[scroll], _body$3[scroll]) - (_window["inner" + dim] || _docEl[client] || _body$3[client]) : element[scroll] - element["offset" + dim];
  ...
  if (e === _window) {
    if (e.pageXOffset != null) {
      ...
      e = _docEl[p] != null ? _docEl : _body$3;
    }
  }
  return function() {
    return e[p];
...
}, _initCore$2 = function _initCore3() {
  gsap$5 = _getGSAP$3();
  if (_windowExists$1() && gsap$5 && typeof document !== "undefined" && document.body) {
    _window = window;
...
var ScrollToPlugin = {
  ...
  init: function init4(target, value, tween, index, targets) {
    ...
    var data = this, snapType = gsap$5.getProperty(target, "scrollSnapType");
    ...
    ScrollTrigger || (ScrollTrigger = gsap$5.core.globals().ScrollTrigger);
    gsap$5.getProperty(target, "scrollBehavior") === "smooth" && gsap$5.set(target, {
      scrollBehavior: "auto"
    });
...
ScrollToPlugin.config = function(vars) {
  _config || _initCore$2() || (_config = gsap$5.config());
  for (var p in vars) {
    _config[p] = vars[p];
  }
};
_getGSAP$3() && gsap$5.registerPlugin(ScrollToPlugin);
/*!
 * strings: 3.13.0
 * https://gsap.com
 *
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var gsap$4, _tempDiv$1, _getGSAP$2 = function _getGSAP4() {
...
_getGSAP$2() && gsap$4.registerPlugin(TextPlugin);
/*!
 * matrix 3.13.0
 * https://gsap.com
 *
...
var _id = 1, _toArray$2, gsap$3, _batch, _batchAction, _body$1, _closestTenth, _getStyleSaver$1, _forEachBatch = function _forEachBatch2(batch, name) {
...
}, _round$1 = function _round3(value) {
  ...
  var cache = el._gsap || gsap$3.core.getCache(el);
  ...
  return anim;
}, _interrupt = function _interrupt3(tl) {
...
var Flip = /* @__PURE__ */ (function() {
  ...
  Flip2.fit = function fit(fromEl, toEl, vars) {
    ...
    return getVars ? v : v.duration ? gsap$3.to(after.element, v) : null;
  };
...
var gsap$2, _win, _doc, _docElement, _body, _tempDiv, _placeholderDiv, _coreInitted$1, _checkPrefix, _toArray$1, _supportsPassive, _isTouchDevice, _touchEventLookup, _isMultiTouching, _isAndroid, InertiaPlugin, _defaultCursor, _supportsPointer, _context$1, _getStyleSaver, _dragCount = 0, _windowExists4 = function _windowExists5() {
  return typeof window !== "undefined";
}, _getGSAP$1 = function _getGSAP5() {
  return gsap$2 || _windowExists4() && (gsap$2 = window.gsap) && gsap$2.registerPlugin && gsap$2;
}, _isFunction4 = function _isFunction5(value) {
  return typeof value === "function";
}, _isObject3 = function _isObject4(value) {
  return typeof value === "object";
}, _isUndefined = function _isUndefined3(value) {
  return typeof value === "undefined";
}, _emptyFunc = function _emptyFunc3() {
  return false;
}, _transformProp = "transform", _transformOriginProp = "transformOrigin", _round4 = function _round5(value) {
  ...
  } else if (context3 === _win || _isUndefined(context3)) {
  ...
  this._skip = false;
  this.enable();
}, _initCore$1 = function _initCore4(required) {
  if (_windowExists4() && document.body) {
    ...
    _addListener3(_doc, "touchcancel", _emptyFunc);
    _addListener3(_win, "touchmove", _emptyFunc);
  ...
  function Draggable2(target, vars) {
    ...
    var type = (vars.type || "x,y").toLowerCase(), xyMode = ~type.indexOf("x") || ~type.indexOf("y"), rotationMode = type.indexOf("rotation") !== -1, xProp = rotationMode ? "rotation" : xyMode ? "x" : "left", yProp = xyMode ? "y" : "top", allowX = !!(~type.indexOf("x") || ~type.indexOf("left") || type === "scroll"), allowY = !!(~type.indexOf("y") || ~type.indexOf("top") || type === "scroll"), minimumMovement = vars.minimumMovement || 2, self = _assertThisInitialized(_this2), triggers = _toArray$1(vars.trigger || vars.handle || target), killProps = {}, dragEndTime = 0, checkAutoScrollBounds = false, autoScrollMarginTop = vars.autoScrollMarginTop || 40, autoScrollMarginRight = vars.autoScrollMarginRight || 40, autoScrollMarginBottom = vars.autoScrollMarginBottom || 40, autoScrollMarginLeft = vars.autoScrollMarginLeft || 40, isClickable = vars.clickableTest || _isClickable, clickTime = 0, gsCache = target._gsap || gsap$2.core.getCache(target), isFixed = _isFixed2(target), getPropAsNum = function getPropAsNum2(property, unit) {
      ...
      if (vars.liveSnap) {
        ...
        snapIsRaw = _isArray(snap3) || _isFunction4(snap3);
        if (rotationMode) {
      ...
      if (touchEventTarget && allowNativeTouchScrolling && !touchDragAxis) {
        ...
        if (dx !== dy && (dx > minimumMovement || dy > minimumMovement) || _isAndroid && allowNativeTouchScrolling === touchDragAxis) {
          ...
          if (self.vars.lockAxisOnTouchScroll !== false && allowX && allowY) {
            ...
            _isFunction4(self.vars.onLockAxis) && self.vars.onLockAxis.call(self, originalEvent);
          }
      ...
      if (rotationMode) {
        ...
        if ((self.lockAxis || self.lockedAxis) && (xChange || yChange)) {
          ...
          if (!temp) {
            ...
            if (temp && _isFunction4(self.vars.onLockAxis)) {
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var gsap, _registerEase, _getGSAP6 = function _getGSAP7() {
  ...
  var taper = vars.taper || "none", a = [], cnt = 0, points = (+vars.points || 20) | 0, i = points, randomize = _boolean(vars.randomize, true), clamp3 = _boolean(vars.clamp), template = gsap ? gsap.parseEase(vars.template) : 0, strength = (+vars.strength || 1) * 0.4, x, y, bump, invX, obj, pnt, recent;
  while (--i > -1) {
...
for (var p in EasePack) {
  EasePack[p].register = _initCore5;
  EasePack[p].version = "3.13.0";
}
_getGSAP6() && gsap.registerPlugin(SlowMo);
...
document.fonts.ready.then(() => {
  gsapWithCSS.set(".split", { opacity: 1 });
  const split = SplitText.create(".brand__text", {
    type: "words",
    wordsClass: "word++",
    wordDelimiter: String.fromCharCode(8205)
  });
  gsapWithCSS.from(split.words, {
    y: -100,
    opacity: 0,
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let tl = gsapWithCSS.timeline({
    scrollTrigger: {
      trigger: ".clients-brands",
      // твій блок
      start: "top 80%",
      // коли верх блоку доходить до 80% висоти вікна
      toggleActions: "play none none reverse"
      // play → коли доходиш, reverse → коли скролиш назад
    }
  });
  tl.from(".clients-brands__title", {
    opacity: 0,
    y: 30,
    duration: 0.6,
    ease: "power3.out"
...
gsapWithCSS.from(".gallery__body", {
  scrollTrigger: {
    trigger: ".gallery",
    start: "top 80%",
    end: "bottom 60%",
    toggleActions: "play reverse play reverse"
    // при скролі назад анімація йде у зворотньому напрямку
  },
  y: 100,
  opacity: 0,
  rotateX: 30,
...
gsapWithCSS.from(".gallery__card", {
  scrollTrigger: {
    trigger: ".gallery",
    start: "top 75%",
    toggleActions: "play reverse play reverse"
...
const splitWork = new SplitText(".work__title p", { type: "words" });
gsapWithCSS.from(splitWork.words, {
  scrollTrigger: {
    trigger: ".work",
    start: "top 75%",
    end: "bottom 50%",
...
gsapWithCSS.from(".footer__block", {
  scrollTrigger: {
    trigger: ".footer",
    start: "top 80%",
    toggleActions: "play reverse play reverse"
...
gsapWithCSS.from(".brand-services .star", {
  scrollTrigger: {
    trigger: ".brand-services",
    start: "top 80%"
  },
  scale: 0,
  rotation: 360,
...
gsapWithCSS.from(".brand-services .title", {
  scrollTrigger: {
    trigger: ".brand-services",
    start: "top 80%"
  },
...
gsapWithCSS.from(".brand-services .service-card", {
  scrollTrigger: {
    trigger: ".brand-services",
    start: "top 70%"
  },
...
gsapWithCSS.from(".brand-services .author img", {
  scrollTrigger: {
    trigger: ".brand-services",
    start: "top 70%"
  },
...
gsapWithCSS.from(".brand-services .author-text", {
  scrollTrigger: {
    trigger: ".brand-services",
    start: "top 70%"
  },
...
gsapWithCSS.from(".services__images", {
  scrollTrigger: {
    trigger: ".services",
    start: "top 80%"
  },
...
gsapWithCSS.from(".services__title", {
  scrollTrigger: {
    trigger: ".services",
    start: "top 80%"
  },
...
gsapWithCSS.from(".services__image img", {
  scrollTrigger: {
...
gsapWithCSS.from(".services__about", {
  scrollTrigger: {
    trigger: ".services__hero",
    start: "top 85%"
  },
...
gsapWithCSS.from(".content-services__cards", {
  scrollTrigger: {
